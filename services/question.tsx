...
export class QuestionService {
  ...
  static async createQuestion(question: Question): Promise<{ error: PostgrestError | null }> {
  ...
  static async deleteQuestionById(questionId: number): Promise<{ error: PostgrestError | null }> {
    const { data, error } = await supabase
      .from('questions')
      .delete()
  ...
  static async deleteQuestionsByExerciseId(exerciseId: number): Promise<{ error: PostgrestError | null }> {
    const { data, error } = await supabase
      .from('questions')
      .delete()
  ...
  static async updateQuestionById(questionId: number, updatedQuestion: Partial<Question>): Promise<{ error: PostgrestError | null }> {
    const { data, error } = await supabase
      .from('questions')
  ...
  static async getQuestionById(questionId: number): Promise<{ question: Question | null; error: PostgrestError | null }> {
    const { data, error } = await supabase
      .from('questions')
      .select('*')
      .eq('questionid', questionId)
  ...
  static async getAllQuestionsByExerciseId(exerciseId: number): Promise<{ questions: Question[] | null; error: PostgrestError | null }> {
    const { data, error } = await supabase
      .from('questions')
      .select('*')
      .eq('exerciseid', exerciseId);
