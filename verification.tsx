...
const VerificationScreen = () => {
  	...
  	return (
    		<View style={styles.enterOtp}>
      			<Image style={[styles.statusBarLight, styles.buttonPosition]} resizeMode="cover" source={require('@/assets/images/status-bar-light.png')} />
      			<View style={[styles.signIn, styles.logPosition]}>
        				<Text style={styles.ingresaElCdigo}>Ingresa el código</Text>
        				<Text style={styles.teEnviamosUn}>Te enviamos un código de un solo uso a tu correo electrónico. Ingrésalo aquí para verificar tu correo.</Text>
      			</View>
      			...
      			<Image style={[styles.arrowBackIcon, styles.logPosition]} resizeMode="cover" source={require('@/assets/images/arrow-back.png')} />
      			...
      			<Image style={styles.imageIcon} resizeMode="cover" source={require('@/assets/images/image.png')} />
    		</View>);
};
