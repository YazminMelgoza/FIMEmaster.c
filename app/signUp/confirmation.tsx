  ...
  return (
    <View style={styles.enterOtp}>
      ...
      <View style={[styles.signIn, styles.logPosition]}>
        <Text
          style={[
            styles.cuentaRegistradaExitosamente,
            styles.ahoraSersTrasladadoLayout,
          ]}
        >
          Confirma tu cuenta
        </Text>
        <Text
          style={[styles.ahoraSersTrasladado, styles.ahoraSersTrasladadoLayout]}
        >
          Hemos enviado un enlace de confirmación a tu correo electrónico, abre
          el enlace para empezar a usar tu cuenta
        </Text>
      </View>
      ...
      <Image
        ...
        resizeMode="cover"
        source={require("../../assets/images/arrow-back2.png")}
      />
